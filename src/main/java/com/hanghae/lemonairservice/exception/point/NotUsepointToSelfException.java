...
public class NotUsepointToSelfException extends ResponseStatusException {
	...
	public static String errorMsg = "본인 방송에 후원하실 수 없습니다.";

	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public NotUsepointToSelfException() {
