...
public class FailedToCreatePointException extends ResponseStatusException {
	...
	public static String errorMsg = "포인트 생성에 실패했습니다.";
	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public FailedToCreatePointException() {
