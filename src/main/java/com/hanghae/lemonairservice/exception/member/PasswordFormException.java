...
public class PasswordFormException extends ResponseStatusException {
	...
	public static String errorMsg = "비밀번호는 최소 8자 이상, 대소문자, 숫자, 특수문자를 포함해야 합니다.";

	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public PasswordFormException() {
