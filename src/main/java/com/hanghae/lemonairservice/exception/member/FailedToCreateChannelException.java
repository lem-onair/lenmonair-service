...
public class FailedToCreateChannelException extends ResponseStatusException {
	...
	public static String errorMsg = "채널 생성에 실패했습니다.";
	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public FailedToCreateChannelException() {
		super(HttpStatus.INTERNAL_SERVER_ERROR,errorMsg);
	}
