package com.hanghae.lemonairservice.exception.refreshtoken;

import org.springframework.http.HttpStatus;
import org.springframework.web.server.ResponseStatusException;

public class NotvalidTokenException extends ResponseStatusException {
	...
	public static String errorMsg = "유효하지 않은 토큰입니다.";
