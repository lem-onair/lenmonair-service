...
public class StreamStartedAtIsNullException extends ResponseStatusException {
	...
	public static String errorMsg = "시작되지 않은 방송입니다.";

	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public StreamStartedAtIsNullException() {
