...
public class NotEqualsStreamKeysException extends ResponseStatusException {
	...
	public static String errorMsg = "스트림 키가 일치하지 않습니다.";

	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public NotEqualsStreamKeysException() {
