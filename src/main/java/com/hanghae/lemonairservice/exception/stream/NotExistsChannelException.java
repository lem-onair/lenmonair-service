...
public class NotExistsChannelException extends ResponseStatusException {
	...
	public static String errorMsg = "해당 멤버의 채널이 존재하지 않습니다.";

	// 3-2. throw new NoOnAirChannelException() 구문으로 예외를 throw할 수 있도록 기본 생성자를 정의합니다.
	public NotExistsChannelException() {
